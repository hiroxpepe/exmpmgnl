...
import org.examproject.mgnl.util.EntryUtils;
...
@Controller
@Template(
    id="exmp-mgnl-blossom:components/richTextEntry",
...
public class RichTextEntryComponent {
    ...
    public static class LinkArea {
        ...
        @RequestMapping("/richTextEntry/entryLink")
    ...
    public String render(
        ...
        return "components/richTextEntry.jsp";
    }
